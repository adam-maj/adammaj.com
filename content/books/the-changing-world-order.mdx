...
All great nations go through cycles that lead to their rise and fall. Ray Dalio identifies the indicators that repeat themselves throughout history which lead to the rise and fall of global superpowers. Then, he makes the case that the United States displays all the indicators of a nation on the decline from it's peak, and that China will be the next dominant global power.

Nations with stable governments, economies, and financial systems are essential for all other forms of progress. This book is the definitive guide to understanding how these environments are created, maintained, and destroyed.
