...
The idea that you should start with the "why" of your business before doing anything else is valuable. Unfortunately, the book spends hundreds of pages explaining to you why "starting with why" is the correct approach - and most of that time is spent defending that point with the same handfull of examples (Apple, Southwest Airlines, Martin Luther King, etc.)

Instead, I would have rather seen more explanation of how to actually start with why. The book also missed out on how relevant it's philosophy is to personal direction as well.
