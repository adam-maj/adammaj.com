...
I don't want to spoil anything in the summary, so I'll just say, everyone should read this, it takes less than 30 minutes. You can find it <a href="https://www.multivax.com/last_question.html" target="_blank">here</a>.
...
- In this story, we see predictions for the future of humanity very in line with how techno-optimists in places like Silicon Valley tend to think it - humans develop AI systems far more intelligent than themselves, are somehow able to control these systems, then eventually they merge with the machines, and become a multiplanetary species.
...
But then, I read the last line, where Multivac said "LET THERE BE LIGHT." An then it took me a second to process. And then I realized - holy shit wait, there is clearly at least one way to reverse entropy - because it happened during the Big Bang.
...
Then also, the lead up to the last line was great - showing the slow an painful burnout of all of humanity, then all the stars in the Universe, and then basically the entire Universe itself. I find this to be a beautiful image - the idea of the Universe slowly dying - an this part also reminded me of [Timelapse of the Future](https://www.youtube.com/watch?v=uD4izuDMUQA), which is also fire.
...
But that's why I would consider this one of the (or the) best science fiction piece I've read.
