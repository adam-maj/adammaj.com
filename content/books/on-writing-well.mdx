...
The most concise and high value density piece on writing that I've seen. William Zinsser has a minimalist approach to writing that focuses on stripping out everything unnecessary and making sure that every word serves a purpose. He also has great perspective on the purpose of writing and what writing in your own voice actually means.

Highly recommend this to everyone (writing well is an important skill no matter what you're doing). I would read just the first section of the book on writing specifics, and you can skip the later sections on specific applications.
