...
Instead of thinking in certainties, think in bets. Map out the possibilities, then assign probabilities to each. Make decisions thoughtfully and understand the risk you take on, but don't fear failure.
