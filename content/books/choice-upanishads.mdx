...
When it comes to the more difficult Upanishads, especially those covering non-dualism, Parthasarthy gives an unnecessarilyy flowery and poetic explanation in a way that wouldn't be helpful for people new to the concepts.
